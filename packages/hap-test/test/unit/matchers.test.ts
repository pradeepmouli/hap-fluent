...
describe("Characteristic Matchers", () => {
  ...
  describe("toHaveCharacteristic", () => {
    ...
    it("should fail when characteristic does not exist", () => {
      ...
      expect(result.message()).toContain(
        'Expected service "Thermostat" to have characteristic "TargetTemperature"',
      );
    });
  });
  ...
  describe("toHaveValue", () => {
    ...
    it("should fail when value does not match", () => {
      ...
      expect(result.pass).toBe(false);
      expect(result.message()).toContain(
        'Expected characteristic "CurrentTemperature" to have value 25, but got 22',
      );
    });
  });
  ...
  describe("toBeInRange", () => {
    ...
    it("should fail when value is below range", () => {
      ...
      expect(result.pass).toBe(false);
      expect(result.message()).toContain(
        'Expected characteristic "CurrentTemperature" value 22 to be in range [25, 30]',
      );
    });
  ...
  describe("toHaveFormat", () => {
    ...
    it("should fail when format does not match", () => {
      ...
      expect(result.pass).toBe(false);
      expect(result.message()).toContain(
        'Expected characteristic "CurrentTemperature" to have format "int", but got "float"',
      );
    });
  });
});
