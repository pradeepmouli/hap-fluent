...
export class NetworkError extends Error {
  ...
  constructor(errorType: NetworkErrorType, message?: string, context?: any) {
    ...
    const fullMessage = [
      ...
      ...(context?.disconnected !== undefined
        ? [`Network state: ${context.disconnected ? "DISCONNECTED" : "CONNECTED"}`]
        : []),
