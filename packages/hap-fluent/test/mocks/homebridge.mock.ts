...
export class MockCharacteristic {
  ...
  public getHandler: (() => Promise<CharacteristicValue>) | undefined;
  public setHandler: CharacteristicSetHandler | undefined;
  ...
  getValue(): CharacteristicValue | undefined {
    return this.value as CharacteristicValue | undefined;
  }
  ...
  setProps(props: PartialAllowingNull<CharacteristicProps>): this {
    this.props = { ...this.props, ...(props || {}) } as Partial<CharacteristicProps>;
    return this;
  }
  ...
  async handleGet(): Promise<CharacteristicValue> {
    ...
    return (this.value ?? 0) as CharacteristicValue;
  }

  async handleSet(value: CharacteristicValue): Promise<void> {
    if (this.setHandler) {
      await this.setHandler(value, undefined);
    }
    this.value = value;
  }
}
...
export class MockService {
  public static readonly UUID: string = "mock-service-uuid";
  public UUID: string;
  public displayName: string;
  ...
  addCharacteristic(characteristic: MockCharacteristic): MockCharacteristic {
    this.characteristics.push(characteristic);
    return characteristic;
  }

  getCharacteristic(name: string): MockCharacteristic | undefined {
    return this.characteristics.find((c) => c.displayName === name || c.UUID === name);
  }
}
...
/**
 * Alias for createMockAccessory to match homebridge API naming
 */
export const createPlatformAccessory = createMockAccessory;

/**
 * Type alias for MockPlatformAccessory
 */
export type PlatformAccessory = MockPlatformAccessory;

/**
 * Mock Service object (collection of service classes)
 */
