...
describe("FluentCharacteristic Property-Based Tests", () => {
  describe("Boolean characteristic values", () => {
    test.prop([fc.boolean()])("should handle any boolean value", async (value) => {
      ...
      const fluent = new FluentCharacteristic(mockChar as unknown as Characteristic, createNoOpLogger());
  ...
  describe("String characteristic values", () => {
    ...
    ])("should handle alphanumeric string values", async (value) => {
  ...
  describe("Enum characteristic values", () => {
    test.prop([fc.integer({ min: 0, max: 3 })])(
      ...
      async (value) => {
        const mockChar = new MockCharacteristic("TargetHeatingCoolingState", "target-state-uuid");
        const fluent = new FluentCharacteristic(mockChar as unknown as Characteristic, createNoOpLogger());
  ...
  describe("Characteristic properties", () => {
    test.prop([
      ...
      const fluentBrightness = new FluentCharacteristic(
        brightnessChar as unknown as Characteristic,
      );
      const fluentHue = new FluentCharacteristic(hueChar as unknown as Characteristic, createNoOpLogger());
      const fluentSaturation = new FluentCharacteristic(
        saturationChar as unknown as Characteristic,
      );
