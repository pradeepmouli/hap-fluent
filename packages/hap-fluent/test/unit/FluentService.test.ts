...
describe("FluentService", () => {
  ...
  describe("wrapService()", () => {
    it("should wrap a service with fluent interface", () => {
      const fluentService = wrapService<(typeof Service)["Lightbulb"]>(
    ...
    it("should allow getting characteristic values via property access", () => {
      ...
      const fluentService = wrapService<(typeof Service)["Lightbulb"]>(
        mockService as unknown as InstanceType<(typeof Service)["Lightbulb"]>,
      );
  ...
  describe("FluentService integration", () => {
    ...
    it("should handle multiple services correctly", () => {
      ...
      const fluentLightbulb = wrapService<(typeof Service)["Lightbulb"]>(
        lightbulbService as unknown as InstanceType<(typeof Service)["Lightbulb"]>,
      );
      const fluentSwitch = wrapService<(typeof Service)["Switch"]>(
        switchService as unknown as InstanceType<(typeof Service)["Switch"]>,
      );
  ...
  describe("error handling", () => {
    it("should handle missing characteristics gracefully", () => {
      ...
      const fluentService = wrapService<(typeof Service)["Lightbulb"]>(
        emptyService as unknown as InstanceType<(typeof Service)["Lightbulb"]>,
      );
