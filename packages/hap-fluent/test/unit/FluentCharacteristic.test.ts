...
describe("FluentCharacteristic", () => {
  ...
  beforeEach(() => {
    ...
    fluentCharacteristic = new FluentCharacteristic(
      mockCharacteristic as unknown as Characteristic,
    );
  });
  ...
  describe("get()", () => {
    ...
    it("should return numeric values correctly", () => {
      ...
      const fluentNumeric = new FluentCharacteristic<number>(
        numericChar as unknown as Characteristic,
      );
    ...
    it("should return string values correctly", () => {
      ...
      const fluentString = new FluentCharacteristic<string>(
        stringChar as unknown as Characteristic,
      );
  ...
  describe("type safety", () => {
    it("should work with boolean types", () => {
      ...
      const fluentBool = new FluentCharacteristic<boolean>(boolChar as unknown as Characteristic);
    ...
    it("should work with number types", () => {
      ...
      const fluentNum = new FluentCharacteristic<number>(numChar as unknown as Characteristic);
    ...
    it("should work with string types", () => {
      ...
      const fluentStr = new FluentCharacteristic<string>(strChar as unknown as Characteristic);
